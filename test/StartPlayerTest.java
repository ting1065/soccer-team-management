...
import soccerteam.StartPlayer;

/**
 * tests for StartPlayer class.
 */
public class StartPlayerTest {

  private StartPlayer testPlayer;
  private StartPlayer testBetterPlayer;
  private StartPlayer testEqualPlayer;

  /**
   * setting up regular object for test.
   */
  @Before public void setUp() {
    testPlayer = new StartPlayer("san", "zhang", LocalDate.of(2014, 4, 1), 3, Position.FORWARD, 11,
        Position.GOALIE);
    testBetterPlayer = new StartPlayer("SI", "lI", LocalDate.of(2015, 8, 31), 5, Position.GOALIE,
        12, Position.FORWARD);
    testEqualPlayer = new StartPlayer("Wu", "ZhAng", LocalDate.of(2016, 1, 2), 3, Position.DEFENDER,
        13, Position.GOALIE);
  }
  ...
  public void testTooOldPlayer() {
    new StartPlayer("san", "zhang", LocalDate.of(1960, 4, 1), 3, Position.FORWARD, 11,
        Position.GOALIE);
  }
  ...
  public void testUnbornPlayer() {
    new StartPlayer("san", "zhang", LocalDate.of(3023, 4, 1), 3, Position.FORWARD, 11,
        Position.MIDFIELDER);
  }
  ...
  public void testNoSkillPlayer() {
    new StartPlayer("san", "zhang", LocalDate.of(2016, 4, 1), 0, Position.FORWARD, 11,
        Position.GOALIE);
  }
  ...
  public void testOverSkilledPlayer() {
    new StartPlayer("san", "zhang", LocalDate.of(2016, 4, 1), 6, Position.FORWARD, 11,
        Position.MIDFIELDER);
  }
  ...
  public void testNumZeroPlayer() {
    new StartPlayer("san", "zhang", LocalDate.of(2016, 4, 1), 6, Position.FORWARD, 0,
        Position.GOALIE);
  }
  ...
  public void testNumTwentyOnePlayer() {
    new StartPlayer("san", "zhang", LocalDate.of(2016, 4, 1), 6, Position.FORWARD, 21,
        Position.MIDFIELDER);
  }
  ...
  /**
   * test if getGamePosition() works as expected.
   */
  @Test public void testGetGamePosition() {
    assertEquals(Position.GOALIE, testPlayer.getGamePosition());
    assertEquals(Position.FORWARD, testBetterPlayer.getGamePosition());
  }
